      ...
      <div className="md:flex Hero">
        <div className="flex flex-col items-center lg:pr-24 md:pr-16  md:items-start md:text-left">
          ...
          <p className=" text-stroke  mb-8 leading-relaxed dark:text-white w-full text-left ">
            Hello, everyone. Thanks for watching my Portfolio. I&apos;ve
            graduated B.S Computer Science in La Roche University. I&apos;m
            trying to be a best Front-End Developer! I hope you like my projects
            and if you want to take a look more details about my projects,
            please visit my github! Thank you so much.
          </p>

          <div className="flex justify-start">
            <Link href="/Projects" legacyBehavior>
              <a className="inline-flex text-title border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 hover:scale-90 duration-300 rounded text-lg">
                Check out some of my projects
              </a>
            </Link>

            <Link
              href="https://portfolio-react-alpha-flax.vercel.app/"
              legacyBehavior
            >
              <a className="inline-flex text-blue-400 font-mono border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 hover:scale-90 duration-300 rounded text-lg">
                ReactJS Portfolio
              </a>
            </Link>
          </div>
        ...
        <div className="w-full ">
          <div className="flex justify-between gap-x-5">
            <button
              ...
              className="text-xl text-title hover:scale-110 duration-300 mb-10"
            >
              What are my Skills?
            </button>
            <button
          ...
          <div
            className={`grid grid-cols-3 gap-3 ${showImages ? "" : "hidden"}`}
          >
          ...
          <div
            className={` flex flex-col text-xl font-semibold gap-y-10 ${
              showParagraph ? "" : "hidden"
            } `}
          >
            {listItems.map((item, index) => (
              <CSSTransition
                ...
                classNames={`image-transition`}
              >
                <li style={{ transitionDelay: `${index * 500}ms` }}>
